local assets=
{
    ...
    --Asset("ATLAS", "images/inventoryimages/dsalucy.xml"),
}
...
local function fn(Sim)
	...
	inst.components.inspectable.nameoverride = "lucy"
    ...
    inst:ListenForEvent("ontalk", function() 
		if inst.components.lucytalk.sound_override then
			inst.SoundEmitter:KillSound("talk")
			inst.SoundEmitter:PlaySound(inst.components.lucytalk.sound_override, "special")
		else
...
return Prefab( "common/inventory/dsalucy", fn, assets)
