...
return MakeBook("ynabook_sleep", sleepfn, 5),
       MakeBook("ynabook_gardening", growfn, 5),
       MakeBook("ynabook_brimstone", firefn, 5),
       MakeBook("ynabook_birds", birdsfn, 3),
       MakeBook("ynabook_tentacles", tentaclesfn, 5)
