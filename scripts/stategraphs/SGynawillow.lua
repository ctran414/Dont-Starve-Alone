...
local states=
{
    ...
    State{
        ...
        onenter = function(inst)
            ...
            inst.Physics:Stop()
			local sound_event = "dontstarve/characters/willow/hurt"
    ...
    State{
        ...
        --[[events=
        {
            EventHandler("animover", function(inst) 	
				...
				skeleton.components.lootdropper:SetLoot({"ynawillowskull"})
...
return StateGraph("ynawillow", states, events, "idle", actionhandlers)
